...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        data.add(new ExpandableListAdapter.Item(ExpandableListAdapter.PROFILE,
        ...
        data.add(new ExpandableListAdapter.Item(ExpandableListAdapter.ALERT,
        ...
        data.add(new ExpandableListAdapter.Item(ExpandableListAdapter.WARNING,
